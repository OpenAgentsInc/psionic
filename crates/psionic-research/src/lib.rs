...
mod tassadar_architecture_bakeoff_summary;
mod tassadar_architecture_comparison;
mod tassadar_article_cpu_reproducibility_summary;
mod tassadar_article_cross_machine_reproducibility_matrix_summary;
mod tassadar_article_demo_benchmark_equivalence_gate_summary;
mod tassadar_article_demo_frontend_parity_summary;
mod tassadar_article_equivalence_blocker_matrix_summary;
mod tassadar_article_equivalence_final_audit_summary;
...
mod tassadar_article_hard_sudoku_benchmark_closure_summary;
mod tassadar_article_hungarian_demo_parity_summary;
mod tassadar_article_interpreter_breadth_envelope_summary;
mod tassadar_article_interpreter_breadth_suite_gate_summary;
mod tassadar_article_interpreter_ownership_gate_summary;
mod tassadar_article_kv_activation_discipline_audit_summary;
mod tassadar_article_representation_invariance_gate_summary;
mod tassadar_article_route_minimality_audit_summary;
mod tassadar_article_runtime_closeout_summary;
mod tassadar_article_single_run_no_spill_closure_summary;
mod tassadar_article_trace_vocabulary_binding_summary;
mod tassadar_article_transformer_artifact_descriptor_summary;
mod tassadar_article_transformer_forward_pass_closure_summary;
mod tassadar_article_transformer_generalization_summary;
mod tassadar_article_transformer_model_closure_summary;
mod tassadar_article_transformer_reference_linear_exactness_summary;
mod tassadar_article_transformer_training_closure_summary;
mod tassadar_article_transformer_weight_lineage_summary;
mod tassadar_article_transformer_weight_production_summary;
...
mod tassadar_broad_family_specialization_summary;
mod tassadar_canonical_transformer_stack_boundary_summary;
mod tassadar_compiled_article_closure;
mod tassadar_compiled_distillation_summary;
...
mod tassadar_module_specialization_benchmark;
mod tassadar_module_state_architecture;
mod tassadar_no_hint_self_supervision;
mod tassadar_owned_transformer_stack_audit_summary;
mod tassadar_pointer_memory_scratchpad_summary;
mod tassadar_post_article_bounded_weighted_plugin_platform_closeout_summary;
mod tassadar_post_article_canonical_computational_model_statement_summary;
mod tassadar_post_article_canonical_machine_identity_lock_summary;
mod tassadar_post_article_canonical_route_semantic_preservation_summary;
mod tassadar_post_article_canonical_route_universal_substrate_gate_summary;
mod tassadar_post_article_carrier_split_contract_summary;
mod tassadar_post_article_continuation_non_computationality_contract_summary;
mod tassadar_post_article_control_plane_decision_provenance_proof_summary;
mod tassadar_post_article_execution_semantics_proof_transport_audit_summary;
mod tassadar_post_article_plugin_authority_promotion_publication_and_trust_tier_gate_summary;
mod tassadar_post_article_plugin_capability_boundary_summary;
mod tassadar_post_article_plugin_charter_authority_boundary_summary;
mod tassadar_post_article_plugin_conformance_sandbox_and_benchmark_harness_summary;
mod tassadar_post_article_plugin_invocation_receipts_and_replay_classes_summary;
mod tassadar_post_article_plugin_manifest_identity_contract_summary;
mod tassadar_post_article_plugin_packet_abi_and_rust_pdk_summary;
mod tassadar_post_article_plugin_result_binding_schema_stability_and_composition_summary;
mod tassadar_post_article_plugin_runtime_api_and_engine_abstraction_summary;
mod tassadar_post_article_plugin_world_mount_envelope_compiler_and_admissibility_summary;
mod tassadar_post_article_rebased_universality_verdict_split_summary;
mod tassadar_post_article_turing_completeness_closeout_summary;
mod tassadar_post_article_universal_machine_proof_rebinding_summary;
mod tassadar_post_article_universality_bridge_contract_summary;
mod tassadar_post_article_universality_portability_minimality_matrix_summary;
mod tassadar_post_article_universality_witness_suite_reissue_summary;
mod tassadar_post_article_weighted_plugin_controller_trace_and_refusal_aware_model_loop_summary;
...
mod tassadar_supervision_density_summary;
...
pub use tassadar_architecture_bakeoff_summary::*;
pub use tassadar_architecture_comparison::*;
pub use tassadar_article_cpu_reproducibility_summary::*;
pub use tassadar_article_cross_machine_reproducibility_matrix_summary::*;
pub use tassadar_article_demo_benchmark_equivalence_gate_summary::*;
pub use tassadar_article_demo_frontend_parity_summary::*;
pub use tassadar_article_equivalence_blocker_matrix_summary::*;
pub use tassadar_article_equivalence_final_audit_summary::*;
...
pub use tassadar_article_hard_sudoku_benchmark_closure_summary::*;
pub use tassadar_article_hungarian_demo_parity_summary::*;
pub use tassadar_article_interpreter_breadth_envelope_summary::*;
pub use tassadar_article_interpreter_breadth_suite_gate_summary::*;
pub use tassadar_article_interpreter_ownership_gate_summary::*;
pub use tassadar_article_kv_activation_discipline_audit_summary::*;
pub use tassadar_article_representation_invariance_gate_summary::*;
pub use tassadar_article_route_minimality_audit_summary::*;
pub use tassadar_article_runtime_closeout_summary::*;
pub use tassadar_article_single_run_no_spill_closure_summary::*;
pub use tassadar_article_trace_vocabulary_binding_summary::*;
pub use tassadar_article_transformer_artifact_descriptor_summary::*;
pub use tassadar_article_transformer_forward_pass_closure_summary::*;
pub use tassadar_article_transformer_generalization_summary::*;
pub use tassadar_article_transformer_model_closure_summary::*;
pub use tassadar_article_transformer_reference_linear_exactness_summary::*;
pub use tassadar_article_transformer_training_closure_summary::*;
pub use tassadar_article_transformer_weight_lineage_summary::*;
pub use tassadar_article_transformer_weight_production_summary::*;
...
pub use tassadar_broad_family_specialization_summary::*;
pub use tassadar_canonical_transformer_stack_boundary_summary::*;
pub use tassadar_compiled_article_closure::*;
pub use tassadar_compiled_distillation_summary::*;
...
pub use tassadar_module_specialization_benchmark::*;
pub use tassadar_module_state_architecture::*;
pub use tassadar_no_hint_self_supervision::*;
pub use tassadar_owned_transformer_stack_audit_summary::*;
pub use tassadar_pointer_memory_scratchpad_summary::*;
pub use tassadar_post_article_bounded_weighted_plugin_platform_closeout_summary::*;
pub use tassadar_post_article_canonical_computational_model_statement_summary::*;
pub use tassadar_post_article_execution_semantics_proof_transport_audit_summary::*;
pub use tassadar_post_article_canonical_machine_identity_lock_summary::*;
pub use tassadar_post_article_continuation_non_computationality_contract_summary::*;
pub use tassadar_post_article_canonical_route_semantic_preservation_summary::*;
pub use tassadar_post_article_canonical_route_universal_substrate_gate_summary::*;
pub use tassadar_post_article_carrier_split_contract_summary::*;
pub use tassadar_post_article_control_plane_decision_provenance_proof_summary::*;
pub use tassadar_post_article_plugin_authority_promotion_publication_and_trust_tier_gate_summary::*;
pub use tassadar_post_article_plugin_capability_boundary_summary::*;
pub use tassadar_post_article_plugin_charter_authority_boundary_summary::*;
pub use tassadar_post_article_plugin_conformance_sandbox_and_benchmark_harness_summary::*;
pub use tassadar_post_article_plugin_invocation_receipts_and_replay_classes_summary::*;
pub use tassadar_post_article_plugin_manifest_identity_contract_summary::*;
pub use tassadar_post_article_plugin_packet_abi_and_rust_pdk_summary::*;
pub use tassadar_post_article_plugin_result_binding_schema_stability_and_composition_summary::*;
pub use tassadar_post_article_plugin_runtime_api_and_engine_abstraction_summary::*;
pub use tassadar_post_article_weighted_plugin_controller_trace_and_refusal_aware_model_loop_summary::*;
pub use tassadar_post_article_plugin_world_mount_envelope_compiler_and_admissibility_summary::*;
pub use tassadar_post_article_rebased_universality_verdict_split_summary::*;
pub use tassadar_post_article_turing_completeness_closeout_summary::*;
pub use tassadar_post_article_universal_machine_proof_rebinding_summary::*;
pub use tassadar_post_article_universality_bridge_contract_summary::*;
pub use tassadar_post_article_universality_portability_minimality_matrix_summary::*;
pub use tassadar_post_article_universality_witness_suite_reissue_summary::*;
...
pub use tassadar_supervision_density_summary::*;

...
use psionic_eval::{
    ...
    build_tassadar_hungarian_10x10_suite, TassadarHungarian10x10ClaimBoundaryReport,
    TassadarHungarian10x10CompiledExecutorBenchmarkReceipt,
    TassadarHungarian10x10CompiledExecutorCompatibilityReport,
    TassadarHungarian10x10CompiledExecutorCorpus, TassadarHungarian10x10CompiledExecutorEvalError,
    TassadarHungarian10x10CompiledExecutorExactnessReport, TassadarReferenceFixtureSuite,
};
...
pub const TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_OUTPUT_DIR: &str =
    "fixtures/tassadar/runs/hungarian_10x10_v0_compiled_executor_v0";
pub const TASSADAR_HUNGARIAN_10X10_BENCHMARK_PACKAGE_FILE: &str = "benchmark_package.json";
pub const TASSADAR_HUNGARIAN_10X10_ENVIRONMENT_BUNDLE_FILE: &str = "environment_bundle.json";
pub const TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_EXACTNESS_REPORT_FILE: &str =
    "compiled_executor_exactness_report.json";
pub const TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_COMPATIBILITY_REPORT_FILE: &str =
    "compiled_executor_compatibility_report.json";
pub const TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_BENCHMARK_RECEIPT_FILE: &str =
    "throughput_benchmark_receipt.json";
pub const TASSADAR_HUNGARIAN_10X10_CLAIM_BOUNDARY_REPORT_FILE: &str = "claim_boundary_report.json";
pub const TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_SUITE_ARTIFACT_FILE: &str =
...
pub struct TassadarHungarian10x10CompiledExecutorDeploymentBundle {
    pub case_id: String,
    pub split: String,
...
impl TassadarHungarian10x10CompiledExecutorDeploymentBundle {
    fn new(
        case_id: &str,
        split: &str,
        deployment_dir: &str,
        ...
        bundle.bundle_digest = stable_digest(
            b"psionic_tassadar_hungarian_10x10_compiled_executor_deployment_bundle|",
            &bundle,
        );
        bundle
    }
...
#[derive(Clone, Debug, PartialEq, Eq, Serialize, Deserialize)]
pub struct TassadarHungarian10x10CompiledExecutorRunBundle {
    pub run_id: String,
    ...
    pub deployments: Vec<TassadarHungarian10x10CompiledExecutorDeploymentBundle>,
...
impl TassadarHungarian10x10CompiledExecutorRunBundle {
    fn new(
        suite: &TassadarReferenceFixtureSuite,
        exactness_report: &TassadarHungarian10x10CompiledExecutorExactnessReport,
        compatibility_report: &TassadarHungarian10x10CompiledExecutorCompatibilityReport,
        throughput_benchmark_receipt: &TassadarHungarian10x10CompiledExecutorBenchmarkReceipt,
        claim_boundary_report: &TassadarHungarian10x10ClaimBoundaryReport,
        compiled_suite_artifact_digest: String,
        deployments: Vec<TassadarHungarian10x10CompiledExecutorDeploymentBundle>,
    ) -> Self {
        let mut bundle = Self {
            run_id: String::from("tassadar-hungarian-10x10-v0-compiled-executor-v0"),
            workload_family_id: exactness_report.workload_family_id.clone(),
            claim_class: TassadarClaimClass::CompiledArticleClass,
            claim_boundary: String::from(
                "exact compiled/proof-backed article-sized 10x10 Hungarian lane on the committed corpus with benchmark, proof, throughput, and explicit learned-lane separation; this lands on the larger search-oriented Wasm profile rather than the tighter article_i32 profile, and it closes the compiled matching article workload, not full compiled article parity by itself",
            ),
            serve_posture: String::from("eval_only"),
            requested_decode_mode: exactness_report.requested_decode_mode,
            benchmark_package_file: String::from(TASSADAR_HUNGARIAN_10X10_BENCHMARK_PACKAGE_FILE),
            environment_bundle_file: String::from(TASSADAR_HUNGARIAN_10X10_ENVIRONMENT_BUNDLE_FILE),
            exactness_report_file: String::from(
                TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_EXACTNESS_REPORT_FILE,
            ),
            compatibility_report_file: String::from(
                TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_COMPATIBILITY_REPORT_FILE,
            ),
            throughput_benchmark_receipt_file: String::from(
                TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_BENCHMARK_RECEIPT_FILE,
            ),
            claim_boundary_report_file: String::from(
                TASSADAR_HUNGARIAN_10X10_CLAIM_BOUNDARY_REPORT_FILE,
            ),
            compiled_suite_artifact_file: String::from(
                TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_SUITE_ARTIFACT_FILE,
            ),
            deployments,
            benchmark_package_digest: suite.benchmark_package.stable_digest(),
            environment_bundle_digest: stable_digest(
                b"psionic_tassadar_hungarian_10x10_environment_bundle|",
        ...
        bundle.bundle_digest = stable_digest(
            b"psionic_tassadar_hungarian_10x10_compiled_executor_run_bundle|",
            &bundle,
        );
        bundle
    }
...
#[derive(Debug, Error)]
pub enum TassadarHungarian10x10CompiledExecutorPersistError {
    #[error(transparent)]
    Eval(#[from] TassadarHungarian10x10CompiledExecutorEvalError),
    #[error(transparent)]
...
pub fn run_tassadar_hungarian_10x10_compiled_executor_bundle(
    output_dir: &Path,
) -> Result<
    TassadarHungarian10x10CompiledExecutorRunBundle,
    TassadarHungarian10x10CompiledExecutorPersistError,
> {
    fs::create_dir_all(output_dir).map_err(|error| {
        TassadarHungarian10x10CompiledExecutorPersistError::CreateDir {
            path: output_dir.display().to_string(),
            error,
        }
    })?;

    let suite = build_tassadar_hungarian_10x10_suite("v0")?;
    let corpus = build_tassadar_hungarian_10x10_compiled_executor_corpus(None)?;
    assert_program_digest_alignment(&suite, &corpus)?;
    let exactness_report = build_tassadar_hungarian_10x10_compiled_executor_exactness_report(
        &corpus,
    ...
    let claim_boundary_report = build_tassadar_hungarian_10x10_claim_boundary_report();

    write_json(
        output_dir.join(TASSADAR_HUNGARIAN_10X10_BENCHMARK_PACKAGE_FILE),
        &suite.benchmark_package,
    )?;
    write_json(
        output_dir.join(TASSADAR_HUNGARIAN_10X10_ENVIRONMENT_BUNDLE_FILE),
        &suite.environment_bundle,
    )?;
    write_json(
        output_dir.join(TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_EXACTNESS_REPORT_FILE),
        &exactness_report,
    )?;
    write_json(
        output_dir.join(TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_COMPATIBILITY_REPORT_FILE),
        &compatibility_report,
    )?;
    write_json(
        output_dir.join(TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_BENCHMARK_RECEIPT_FILE),
        &throughput_benchmark_receipt,
    )?;
    write_json(
        output_dir.join(TASSADAR_HUNGARIAN_10X10_CLAIM_BOUNDARY_REPORT_FILE),
        &claim_boundary_report,
    )?;
    write_json(
        output_dir.join(TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_SUITE_ARTIFACT_FILE),
        &corpus.compiled_suite_artifact,
    )?;

    let deployments = persist_deployments(output_dir, &corpus)?;
    let bundle = TassadarHungarian10x10CompiledExecutorRunBundle::new(
        &suite,
        &exactness_report,
        &compatibility_report,
        &throughput_benchmark_receipt,
...
fn assert_program_digest_alignment(
...
) -> Result<(), TassadarHungarian10x10CompiledExecutorPersistError> {
    ...
    for (case_id, benchmark_program_digest) in benchmark_digests {
        let Some(compiled_program_digest) = compiled_digests.get(&case_id) else {
            return Err(
                TassadarHungarian10x10CompiledExecutorPersistError::ProgramDigestMismatch {
                    case_id,
...
fn persist_deployments(
    ...
    Vec<TassadarHungarian10x10CompiledExecutorDeploymentBundle>,
    TassadarHungarian10x10CompiledExecutorPersistError,
> {
    ...
    for case in &corpus.cases {
        ...
        bundles.push(TassadarHungarian10x10CompiledExecutorDeploymentBundle::new(
            case.case_id.as_str(),
            case.split.as_str(),
    ...
    T: Serialize,
{
    ...
    let bytes = serde_json::to_vec_pretty(value)
        .expect("Tassadar Hungarian-10x10 compiled executor bundle artifact should serialize");
    fs::write(path, &bytes).map_err(|error| {
        TassadarHungarian10x10CompiledExecutorPersistError::Write {
    ...
    T: Serialize,
{
    let encoded = serde_json::to_vec(value)
        .expect("Tassadar Hungarian-10x10 compiled executor bundle should serialize");
...
mod tests {
    ...
    use super::{
        run_tassadar_hungarian_10x10_compiled_executor_bundle, RUN_BUNDLE_FILE,
        TASSADAR_HUNGARIAN_10X10_BENCHMARK_PACKAGE_FILE,
        TASSADAR_HUNGARIAN_10X10_CLAIM_BOUNDARY_REPORT_FILE,
        TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_BENCHMARK_RECEIPT_FILE,
        TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_COMPATIBILITY_REPORT_FILE,
        TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_EXACTNESS_REPORT_FILE,
        TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_SUITE_ARTIFACT_FILE,
        TASSADAR_HUNGARIAN_10X10_ENVIRONMENT_BUNDLE_FILE,
    };
    use psionic_runtime::TassadarClaimClass;

    #[test]
    fn compiled_hungarian_10x10_executor_bundle_writes_reports_and_deployments(
    ) -> Result<(), Box<dyn std::error::Error>> {
        let temp = tempdir()?;
        let bundle = run_tassadar_hungarian_10x10_compiled_executor_bundle(temp.path())?;

        assert_eq!(bundle.claim_class, TassadarClaimClass::CompiledArticleClass);
        assert_eq!(bundle.deployments.len(), 4);
        assert!(temp
            .path()
            .join(TASSADAR_HUNGARIAN_10X10_BENCHMARK_PACKAGE_FILE)
            .exists());
        assert!(temp
            .path()
            .join(TASSADAR_HUNGARIAN_10X10_ENVIRONMENT_BUNDLE_FILE)
            .exists());
        assert!(temp
            .path()
            .join(TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_EXACTNESS_REPORT_FILE)
            .exists());
        assert!(temp
            .path()
            .join(TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_COMPATIBILITY_REPORT_FILE)
            .exists());
        assert!(temp
            .path()
            .join(TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_BENCHMARK_RECEIPT_FILE)
            .exists());
        assert!(temp
            .path()
            .join(TASSADAR_HUNGARIAN_10X10_CLAIM_BOUNDARY_REPORT_FILE)
            .exists());
        assert!(temp
            .path()
            .join(TASSADAR_HUNGARIAN_10X10_COMPILED_EXECUTOR_SUITE_ARTIFACT_FILE)
            .exists());
        assert!(temp.path().join(RUN_BUNDLE_FILE).exists());
        assert!(temp
            .path()
            .join("deployments")
            .join("hungarian_10x10_validation_a")
            .join("runtime_trace_proof.json")
            .exists());
        Ok(())
    }
}

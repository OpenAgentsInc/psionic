    ...
    fn sandbox_execution_receipt(
        ...
        ProviderSandboxExecutionReceipt {
            ...
            evidence: ProviderSandboxDeliveryEvidence {
                ...
                declared_network_policy: String::from("none"),
                requested_network_policy: String::from("none"),
                declared_filesystem_policy: String::from("workspace_rw"),
                requested_filesystem_policy: String::from("workspace_rw"),
                declared_timeout_limit_s: 30,
                requested_timeout_s: 30,
                artifact_output_policy: String::from("declared_outputs_only"),
                secret_policy: String::from("no_secrets"),

...
use psionic_train::{
    ...
    PsionActualPretrainingTopologyStorageBundle,
    ...
    match cli {
        Cli::Start {
            ...
            let launch_manifest = PsionActualPretrainingLaunchManifest {
                ...
                detail: String::from(
                    "Launch manifest binds the actual pretraining operator command to the frozen lane, recipe, topology/storage, evidence, and git-provenance surfaces.",
                ),
            };
        ...
        Cli::Resume {
            ...
            let resume_manifest = PsionActualPretrainingResumeManifest {
                ...
                dirty_tree_admission: dirty_tree_admission.clone(),
                workspace_status_sha256: workspace_status_sha256.clone(),
                latest_checkpoint_pointer_path: retained_paths.latest_checkpoint_pointer_path.clone(),
                ...
                detail: String::from(
                    "Resume manifest records the exact accepted checkpoint selection and repeats launcher provenance for restart decisions.",
                ),
            };

...
jq -e '
  ...
  and (.acceptance_gate_tie.blocked_issue_ids[0] == "TAS-180")
...
jq -e '
  .closed_required_issue_count == 28
  and .passed_required_requirement_count == 30
  and (.blocked_issue_ids[0] == "TAS-180")

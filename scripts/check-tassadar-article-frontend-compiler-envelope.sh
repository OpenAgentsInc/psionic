...
jq -e '
  ...
  and (.acceptance_gate_tie.blocked_issue_ids[0] == "TAS-178")
...
jq -e '
  .closed_required_issue_count == 25
  and .passed_required_requirement_count == 27
  and (.blocked_issue_ids[0] == "TAS-178")

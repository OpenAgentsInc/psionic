...
jq -e '
  ...
  and .closed_required_issue_count == 26
  and .passed_required_requirement_count == 28
  ...
  and ((.failed_requirement_ids | index("TAS-179")) != null)
  and ((.optional_open_issue_ids | index("TAS-R1")) != null)
  and ((.blocked_issue_ids | length) > 0)
  and (.blocked_issue_ids[0] == "TAS-179")
